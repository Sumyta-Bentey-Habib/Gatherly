    ...
    const fetchBooking = async () => {
      try {
        ...
        if (!data || data.status !== "Pending") {
          toast.error("Invalid or already processed booking.");
      ...
      setTimeout(() => {
        ...
        setTimeout(async () => {
          try {
            ...
            console.error(e);
            toast.error("Network error: Could not complete payment.");
          } finally {
            setProcessing(false);
          }
        }, 1000);
      ...
      <SuccessContainer>
        ...
        >
          ...
          <p style={{ color: "rgba(25, 28, 29, 0.8)", fontSize: "14px", marginBottom: "24px" }}>
            Your booking for <strong style={{ color: "#000000" }}>{booking.eventTitle}</strong> has been secured.
          </p>
          ...
          <SuccessReceipt>
            ...
            <ReceiptRow>
              ...
              <ReceiptVal>{booking.guests} guest(s)</ReceiptVal>
            </ReceiptRow>
            <ReceiptRow>
              <ReceiptLabel>Event Date:</ReceiptLabel>
              <ReceiptVal>{booking.date}</ReceiptVal>
            </ReceiptRow>
          ...
          <SummaryCard>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
              <div>
                ...
                <SummaryTourTitle>{booking.eventTitle}</SummaryTourTitle>
              </div>

              <DetailRow>
                <DetailCell>
                  <DetailLabel>Event Date</DetailLabel>
                  <DetailVal>{booking.date}</DetailVal>
                </DetailCell>
                <DetailCell>
                  <DetailLabel>Guests</DetailLabel>
                  <DetailVal>{booking.guests} guest(s)</DetailVal>
                </DetailCell>
              </DetailRow>
  ...
  return (
    <>
      ...
      <Suspense fallback={
        ...
        <PaymentContent bookingId={unwrappedParams.id} />
      </Suspense>
    </>
  );
}
